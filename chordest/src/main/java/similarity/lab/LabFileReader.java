...
import similarity.chord.parser.ChordParser;
import similarity.chord.parser.ParseException;
import similarity.chord.parser.TokenMgrError;
...
//			chordsTemp.add(Chord.empty());
			...
			LOG.info("Chords were read from " + lab.getAbsolutePath());
