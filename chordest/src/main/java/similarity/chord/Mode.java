...
public class Mode {
	...
	public static final Mode A_MAJ = new Mode(Note.A, Chord.MAJ);
	public static final Mode AD_MAJ = new Mode(Note.AD, Chord.MAJ);
	public static final Mode B_MAJ = new Mode(Note.B, Chord.MAJ);
	public static final Mode C_MAJ = new Mode(Note.C, Chord.MAJ);
	public static final Mode CD_MAJ = new Mode(Note.CD, Chord.MAJ);
	public static final Mode D_MAJ = new Mode(Note.D, Chord.MAJ);
	public static final Mode DD_MAJ = new Mode(Note.DD, Chord.MAJ);
	public static final Mode E_MAJ = new Mode(Note.E, Chord.MAJ);
	public static final Mode F_MAJ = new Mode(Note.F, Chord.MAJ);
	public static final Mode FD_MAJ = new Mode(Note.FD, Chord.MAJ);
	public static final Mode G_MAJ = new Mode(Note.G, Chord.MAJ);
	public static final Mode GD_MAJ = new Mode(Note.GD, Chord.MAJ);

	public static final Mode[] MAJORS = new Mode[] { A_MAJ, AD_MAJ, B_MAJ,
	...
	public Mode(Note root, String type) {
		this.root = root;
		this.type = type;
	}
...
//		result.add(new Chord(notes.get(5), Chord.MIN7));
	 ...
	 * @return
	 */
	public static Mode recognizeMode(double[] durations, Note startNote) {
		if (durations == null) {
		...
		return new Mode(startNote.withOffset(maxPos), Chord.MAJ);
	}
