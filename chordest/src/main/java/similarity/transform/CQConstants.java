...
import similarity.transform.window.HammingWindowFunction;
import similarity.transform.window.IWindowFunction;
import similarity.util.ComplexNumber;
import similarity.util.QUtil;
