...
/*
 ...
 This code was taken at 1:23 2011-Nov-29 from 
 https://github.com/tb2332/MSongsDB/blob/master/JavaSrc/hdf5_getters.java
 */
...
public class Hdf5Getters {
	...
	public static int get_member_int(H5File h5, int songidx, String table,
		...
		Vector<int[]> alldata = (Vector<int[]>) analysis.getData();
	...
	public static double get_member_double(H5File h5, int songidx,
		...
		assert (wantedMember >= 0);
		@SuppressWarnings("unchecked")
		Vector<double[]> alldata = (Vector<double[]>) analysis.getData();
	...
	public static String get_member_string(H5File h5, int songidx,
		...
		assert (wantedMember >= 0);
		@SuppressWarnings("unchecked")
		Vector<String[]> alldata = (Vector<String[]>) analysis.getData();
