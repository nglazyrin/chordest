...
public class Configuration {
	...
	public Configuration(String propertiesFile) {
        ...
        this.spectrum = new SpectrumProperties(octaves, notesPerOctave, offsetFromF0);
	...
	public class SpectrumProperties {
		...
		private SpectrumProperties(int octaves, int notesPerOctave, int offsetFromF0InSemitones) {
