...
// File is downloaded from http://www.labbookpages.co.uk/audio/javaWavFiles.html
...
public class WavFile {
	...
	public static WavFile openWavFile(File file) throws IOException,
		...
		if (file.length() != chunkSize + 8) {
			// XXX: some files have these sizes differ by 9, not 8. NGlazyrin, 2012-Jan-05
			if (file.length() != chunkSize + 9) {
